...
public class PratoController implements Initializable {
	...
	/**
	 * Função do botão Excluir  responsável por abrir a tela para exclusão
	 * de Prato
	 * 
	 * @param Event
	 * @throws IOException
	...
	public void onBtExcluir(ActionEvent Event) throws IOException {
		...
		Parent root = FXMLLoader.load(getClass().getResource("/views/ExcluirPratoView.fxml"));
	...
	/**
	 * Função do botão Adicionar prato responsável por abrir a tela para adição
	 * de prato
	 * 
	 * @param Event
	 * @throws IOException
	 */
	@FXML
	public void onBtAdicionarPrato(ActionEvent Event) throws IOException {

		Parent root = FXMLLoader.load(getClass().getResource("/views/AdicionarPratoView.fxml"));
		Stage primaryStage = new Stage();
		Scene scene = new Scene(root);
		primaryStage.setTitle("Cadastro de Fornecedor");
		primaryStage.setScene(scene);
		primaryStage.initModality(Modality.APPLICATION_MODAL);
		primaryStage.initOwner(btNovoPrato.getScene().getWindow());
		primaryStage.show();
	...
	/**
	 * Função do botão Editar prato responsável por abrir a tela para edição de
	 * prato
	 * 
	 * @param Event
	 * @throws IOException
	 */
	@FXML
	public void onBtEditarPrato(ActionEvent Event) throws IOException {

		Parent root = FXMLLoader.load(getClass().getResource("/views/EditarPratoView.fxml"));
		Stage primaryStage = new Stage();
		Scene scene = new Scene(root);
