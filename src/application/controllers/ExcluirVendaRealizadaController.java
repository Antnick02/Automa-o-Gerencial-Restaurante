...
public class ExcluirVendaRealizadaController implements Initializable {
	...
	/**
	 * Função responsável por checar a entrada e realizar a exclusão de uma venda
	 */
	private void checarEntrada() {

		String entradaIdVenda = idVenda.getText();

		if (Verificacoes.verificaIdVenda(entradaIdVenda, GerenciarVenda.getVendas())) {
			int id2 = Integer.parseInt(entradaIdVenda);
			GerenciarVenda.excluirVenda(id2);
